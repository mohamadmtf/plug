...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Norton X!\n\nTo get a list of Norton X groups use /chats or /chatlist for a document list of chats.\n\nTo get a new Norton X group, contact a support group:\n\nForPersian support, use: /join Persian support\n\nFor more information, check out our channels:\n\n@NortonTeam [Persian]\n\nThanks for using @Norton X!"
     	return text
    end
